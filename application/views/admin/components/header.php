...
<head>
    ...
    <meta name="description" content="Multi-tenant CRM">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Administrator Setting</h3><!-- /.menu-title -->
					<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-users"></i><a href="<?= base_url('admin/roles')?>">User Roles</a></li>
...
<?php if($this->session->flashdata('msg')){?>
         <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Success</span> &nbsp;<?= $this->session->flashdata('msg');?>
